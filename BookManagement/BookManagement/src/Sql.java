...
/*
Calendar dueDay=Calendar.getInstance();
dueDay.add(Calendar.MONTH, 1);	//plus 1 because default month start from 0
System.out.printf("%s-%s-%s\n",dueDay.get(Calendar.YEAR),dueDay.get(Calendar.MONTH),dueDay.get(Calendar.DATE));
dueDay.add(Calendar.DATE, 7);
System.out.printf("%s-%s-%s\n",dueDay.get(Calendar.YEAR),dueDay.get(Calendar.MONTH),dueDay.get(Calendar.DATE));

String sDate1="2020-05-12";  
Date date1;
try {
